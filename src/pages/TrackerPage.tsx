...
import {
  ...
  ChevronLeft, CreditCard, ArrowRight, Phone
} from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        {order.review_status === 'pending' && (
          <div className={`p-4 rounded-2xl mb-6 ${
            ...
            <p className="font-bold mb-1 flex items-center gap-1.5"><Phone size={14} /> Register call in progress</p>
        ...
        {order.review_status === 'approved' && (
          <div className={`p-4 rounded-2xl mb-6 ${
            ...
            <p className="font-bold flex items-center gap-1.5"><CheckCircle size={14} /> Register call complete — your order is approved!</p>
