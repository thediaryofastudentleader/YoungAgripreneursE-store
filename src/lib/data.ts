...
export const products: Product[] = [
  ...
  { id: 'jw-3', title: 'Italian Charms Bracelet Set 9 modular 9mm charms', price: 930.00, description: 'a classic starter bracelet, 9 modular 9mm charms, and a handy tool for easy assembly. Made from durable stainless steel in silver and gold tones, the charms feature retractable snaps for effortless customization. Compatible with major Italian charm brands and perfect for gifting or DIY moments with loved ones.

', image: '/images/charm-bracelet.jpg', category: 'jewelry', stock: 22, new: true, rating: 4.3, reviews: 11 },
