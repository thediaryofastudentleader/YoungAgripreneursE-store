...
export const products: Product[] = [
  ...
  // Plastic Storage
  { id: 'ka-1', title: '3pc Bowl Set & Lids - Cherry (1.25lt, 2.5lt, 5lt)', price: 699.00, originalPrice: 729.00, description: '3pc Bowl Set & Lids - Cherry (1.25lt, 2.5lt, 5lt)', image: '/images/kettle.jpg', category: 'kitchen-appliances', stock: 15, trending: true, rating: 4.5, reviews: 28 },
  { id: 'ka-2', title: 'Curve Water Bottle 1,1lt - Green', price: 169.00, originalPrice: 199.99, description: 'Curve Water Bottle 1,1lt - Green', image: '/images/toaster.jpg', category: 'kitchen-appliances', stock: 12, rating: 4.3, reviews: 19 },
  { id: 'ka-3', title: 'Hexagon Water Bottle 500ml - Teal', price: 119.00, description: 'Hexagon Water Bottle 500ml - Teal', image: '/images/blender.jpg', category: 'kitchen-appliances', stock: 8, new: true, rating: 4.6, reviews: 14 },
  { id: 'ka-4', title: 'Square Food Storage 3Lt - Teal', price: 200.00, originalPrice: 239.00, description: 'Square Food Storage 3Lt - Teal', image: '/images/microwave.jpg', category: 'kitchen-appliances', stock: 6, special: true, rating: 4.4, reviews: 32 },
  { id: 'ka-5', title: 'Large Marinator - Teal', price: 300.00, description: 'Large Marinator - Teal', image: '/images/rice-cooker.jpg', category: 'kitchen-appliances', stock: 10, rating: 4.2, reviews: 21 },
  ...
  { id: 'mt-4', title: 'Grey Polo Neck T-shirt', price: 109.00, description: 'the Truworths Man Grey Polo Neck T-shirt, featuring long sleeves and crafted from cotton-rich fleece for comfort and style.', image: '/images/mens-grey-tee.jpg', category: 'mens-tshirts', stock: 15, rating: 4.1, reviews: 11 },
  ...
  { id: 'mt-4', title: 'Graphic Balloon Art Relaxed Tee Men', price: 649.00, description: 'the Truworths Man Grey Polo Neck T-shirt, featuring long sleeves and crafted from cotton-rich fleece for comfort and style.', image: '/images/mens-grey-tee.jpg', category: 'mens-tshirts', stock: 15, rating: 4.1, reviews: 11 },

  // Men's Pants
  { id: 'mt-1', title: 'PUMA Sport Sweatpants Men', price: 1120.00, description: 'White Daniel Hechter T-shirt in a cotton-blend knit, featuring short sleeves and a clean white finish.', image: '/images/mens-white-tee.jpg', category: 'mens-tshirts', stock: 25, trending: true, rating: 4.5, reviews: 42 },
  { id: 'mt-2', title: 'Essentials No. 1 Logo Slim Sweatpants Men', price: 849.00, description: 'Black Fuel graphic T-shirt made from carded single jersey, with short sleeves and a classic black finish.', image: '/images/mens-graphic-tee.jpg', category: 'mens-tshirts', stock: 18, new: true, rating: 4.2, reviews: 19 },
  { id: 'mt-3', title: 'PUMA Sport Woven Track Pants Men', price: 260.00, description: 'White and navy Hemisphere Sport T-shirt made from Airtex fabric, with short sleeves and a breathable, athletic look.', image: '/images/mens-navy-tee.jpg', category: 'mens-tshirts', stock: 20, rating: 4.3, reviews: 16 },
  { id: 'mt-4', title: 'PUMATECH Pants Men', price: 1349.00, description: 'the Truworths Man Grey Polo Neck T-shirt, featuring long sleeves and crafted from cotton-rich fleece for comfort and style.', image: '/images/mens-grey-tee.jpg', category: 'mens-tshirts', stock: 15, rating: 4.1, reviews: 11 },

  // Men's Shorts
  { id: 'mt-1', title: 'INDIVIDUAL Padel Training Shorts Men', price: 2320.00, description: 'White Daniel Hechter T-shirt in a cotton-blend knit, featuring short sleeves and a clean white finish.', image: '/images/mens-white-tee.jpg', category: 'mens-tshirts', stock: 25, trending: true, rating: 4.5, reviews: 42 },
  { id: 'mt-2', title: 'Essentials Big No. 1 Logo 10" Shorts Men', price: 619.00, description: 'Black Fuel graphic T-shirt made from carded single jersey, with short sleeves and a classic black finish.', image: '/images/mens-graphic-tee.jpg', category: 'mens-tshirts', stock: 18, new: true, rating: 4.2, reviews: 19 },
  { id: 'mt-3', title: 'Neymar Jr Playmaker Training Football Shorts Men', price: 850.00, description: 'White and navy Hemisphere Sport T-shirt made from Airtex fabric, with short sleeves and a breathable, athletic look.', image: '/images/mens-navy-tee.jpg', category: 'mens-tshirts', stock: 20, rating: 4.3, reviews: 16 },

  // Men's Men's Jackets
  { id: 'mt-4', title: 'Essentials No. 1 Logo Track Jacket Men', price: 1149.00, description: 'the Truworths Man Grey Polo Neck T-shirt, featuring long sleeves and crafted from cotton-rich fleece for comfort and style.', image: '/images/mens-grey-tee.jpg', category: 'mens-tshirts', stock: 15, rating: 4.1, reviews: 11 },
  { id: 'mt-4', title: 'PUMATECH Relaxed Track Jacket Men', price: 2549.00, description: 'the Truworths Man Grey Polo Neck T-shirt, featuring long sleeves and crafted from cotton-rich fleece for comfort and style.', image: '/images/mens-grey-tee.jpg', category: 'mens-tshirts', stock: 15, rating: 4.1, reviews: 11 },

  // Men's Crews & Hoodies
  { id: 'mt-1', title: 'Essentials Elevated Cat Logo Relaxed Sweatshirt Men', price: 2320.00, description: 'White Daniel Hechter T-shirt in a cotton-blend knit, featuring short sleeves and a clean white finish.', image: '/images/mens-white-tee.jpg', category: 'mens-tshirts', stock: 25, trending: true, rating: 4.5, reviews: 42 },
  { id: 'mt-2', title: 'BMW M MOTORSPORT Lifestyle Relaxed Hoodie Men', price: 619.00, description: 'Black Fuel graphic T-shirt made from carded single jersey, with short sleeves and a classic black finish.', image: '/images/mens-graphic-tee.jpg', category: 'mens-tshirts', stock: 18, new: true, rating: 4.2, reviews: 19 },

   // Men's Caps & Hats
  { id: 'mt-3', title: 'PUMA x ASTON MARTIN ARAMCO F1® TEAM Baseball Cap', price: 850.00, description: 'White and navy Hemisphere Sport T-shirt made from Airtex fabric, with short sleeves and a breathable, athletic look.', image: '/images/mens-navy-tee.jpg', category: 'mens-tshirts', stock: 20, rating: 4.3, reviews: 16 },
  { id: 'mt-3', title: 'BMW MMS AOP Bucket Hat', price: 850.00, description: 'White and navy Hemisphere Sport T-shirt made from Airtex fabric, with short sleeves and a breathable, athletic look.', image: '/images/mens-navy-tee.jpg', category: 'mens-tshirts', stock: 20, rating: 4.3, reviews: 16 },
 ...
 { id: 'mt-1', title: 'Training Bottle', price: 249.00, description: 'White Daniel Hechter T-shirt in a cotton-blend knit, featuring short sleeves and a clean white finish.', image: '/images/mens-white-tee.jpg', category: 'mens-tshirts', stock: 25, trending: true, rating: 4.5, reviews: 42 },
  ...
  //Fragrances
   { id: 'hc-1', title: 'Lady Million - 30ml', price: 239.00, description: 'Lady Million – 30ml: A dazzling, seductive fragrance for women who radiate confidence and luxury with a bold, sensual presence.', image: '/images/surface-cleaner.jpg', category: 'household-cleaners', stock: 40, rating: 4.4, reviews: 18 },
  { id: 'hc-2', title: 'Magnetic Impact - 60ml (For Him)', price: 412.00, description: 'Magnetic Impact - 60ml (For Him)', image: '/images/dish-liquid.jpg', category: 'household-cleaners', stock: 35, trending: true, rating: 4.2, reviews: 22 },
  { id: 'hc-3', title: 'Truly Charming - 50ml', price: 430.00, description: 'Truly Charming - 50ml', image: '/images/laundry.jpg', category: 'household-cleaners', stock: 22, rating: 4.6, reviews: 31 },
  { id: 'hc-4', title: 'Signature Glow - 50ml (For Her)', price: 322.00, description: 'Signature Glow - 50ml (For Her)', image: '/images/disinfectant.jpg', category: 'household-cleaners', stock: 28, rating: 4.3, reviews: 15 },
  { id: 'hc-4', title: 'Red Door - 50ml', price: 460.00, description: 'Red Door - 50ml', image: '/images/disinfectant.jpg', category: 'household-cleaners', stock: 28, rating: 4.3, reviews: 15 },


  // Women's Wigs
{ id: 'wt-1', title: '12'' Afro Kinky Curl Ponytail', price: 1070.00, description: '12'' Afro Kinky Curl Ponytail', image: '/images/womens-crop-tee.jpg', category: 'womens-tshirts', stock: 22, trending: true, rating: 4.4, reviews: 27 },
  { id: 'wt-2', title: '10'' Deep Wave Bob 4x4 Wig', price: 2070.00, description: '10'' Deep Wave Bob 4x4 Wig', image: '/images/womens-pink-tee.jpg', category: 'womens-tshirts', stock: 16, new: true, rating: 4.6, reviews: 14 },
  { id: 'wt-3', title: ' Wig Short Curly Human Hair Wigs for Black Women Full Machine Made Wigs Glueless Wig Afro y Curly Wigs', price: 1250.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'WERD Long Black Wavy Wigs for Women Black Curly Wig with Middle Part Synthetic 26 Inch', price: 1500.00, description: 'Made from heat-resistant synthetic fiber, this black wig is lightweight, soft, durable, and looks natural with a hand-tied hairline. The curls last longer and the finish is realistic without extra shine.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-1', title: 'Ombre Long Dirty Blonde Wig for Women,26 Inch Wavy Middle Part Wigs', price: 1100.00, description: 'Transform your style instantly with the WERD Long Black Wavy Wig: soft, natural-looking, heat-resistant, and comfortable—perfect for any occasion.', image: '/images/womens-crop-tee.jpg', category: 'womens-tshirts', stock: 22, trending: true, rating: 4.4, reviews: 27 },
  { id: 'wt-2', title: 'RENERSHOW Medium Length Blonde Balayage Bob Wig with Bangs for White Women', price: 1399.00, description: 'Step out in style with the RENERSHOW Blonde Balayage Bob Wig—platinum with brown roots, soft and natural-looking, heat-resistant, and comfortable. This chic, layered bob with bangs is easy to wear and perfect for any occasion.', image: '/images/womens-pink-tee.jpg', category: 'womens-tshirts', stock: 16, new: true, rating: 4.6, reviews: 14 },
  { id: 'wt-3', title: 'DULOVE Lace Front Wigs Human Hair Glueless Pre plucked Pre Cut, 24 Inch Human Hair Wig', price: 2199.00, description: 'Experience the DULOVE 24" Glueless Lace Front Wig—100% Brazilian virgin human hair, silky straight, pre-plucked for a natural look. Breathable, comfortable, and easy to style, this wig is perfect for any occasion and stays secure all day without glue.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: ' 8 Inch Wigs Human Hair Pre Plucked Pre Cut 4x4 HD Lace Closure Curly Wigs for Black Women Deep Wave Lace Front Glueless ', price: 3470.00, description: 'Get easy, natural style with this 8" Wear and Go Glueless Curly Bob Wig—100% human hair, pre-plucked and pre-cut HD lace, comfortable and secure with no glue needed. Full, soft, and beginner-friendly for any occasion.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
   { id: 'wt-4', title: '20" Glueless Brazilian Human Hair Lace Front Wig—soft, straight, and natural ', price: 1670.00, description: 'Enhance your style with the Ambeson 20" Glueless Brazilian Human Hair Lace Front Wig—soft, straight, and natural with 13x4 transparent lace. Full, tangle-free, and comfortable, this wig is easy to wear and perfect for any occasion.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-4', title: 'Short Curly Pixie Lace Front Wig—100% Brazilian human hair, natural black, pre-plucked HD lace ', price: 600.00, description: 'Turn heads with the Profairsor Short Curly Pixie Lace Front Wig—100% Brazilian human hair, natural black, pre-plucked HD lace, and full, bouncy curls. Comfortable, glueless, and easy to wear for any occasion.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-4', title: '12" Straight Highlight Lace Wig—100% human hair, HD lace front, tangle-free', price: 870.00, description: 'Shine with the RoseTask 12" Straight Highlight Lace Wig—100% human hair, HD lace front, tangle-free, and easy to style. A secure, natural fit for effortless beauty every day or on special occasions.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  ...
  { id: 'wt-1', title: 'PUMA x HYROX Cropped Oversized Lifestyle Tee Women', price: 1050.00, description: 'Inwear Pink Side Trim Cropped Top—a stylish crop top in vibrant pink, crafted from 100% polyester with side trim detail, short sleeves, and a classic crew neck.', image: '/images/womens-crop-tee.jpg', category: 'womens-tshirts', stock: 22, trending: true, rating: 4.4, reviews: 27 },
  { id: 'wt-2', title: 'Graphic Cherry Tee Women', price: 410.00, description: 'a retro-inspired piece with brown and pink stripes, a relaxed fit, and classic polo collar. Crafted from breathable cotton single jersey with a half-button placket and 3/4 sleeves.', image: '/images/womens-pink-tee.jpg', category: 'womens-tshirts', stock: 16, new: true, rating: 4.6, reviews: 14 },
  { id: 'wt-3', title: 'Street Glam Oversized Graphic Tee Women', price: 840.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Run Culture Collective Relaxed Washed Sleeveless Graphic Tee Women', price: 750.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  
  // Women's Pants & Tights
   { id: 'wt-1', title: 'Essentials No. 1 Logo 7'' Short Leggings Women', price: 500.00, description: 'Inwear Pink Side Trim Cropped Top—a stylish crop top in vibrant pink, crafted from 100% polyester with side trim detail, short sleeves, and a classic crew neck.', image: '/images/womens-crop-tee.jpg', category: 'womens-tshirts', stock: 22, trending: true, rating: 4.4, reviews: 27 },
  { id: 'wt-2', title: 'BMW M MOTORSPORT Relaxed Pants Women', price: 2040.00, description: 'a retro-inspired piece with brown and pink stripes, a relaxed fit, and classic polo collar. Crafted from breathable cotton single jersey with a half-button placket and 3/4 sleeves.', image: '/images/womens-pink-tee.jpg', category: 'womens-tshirts', stock: 16, new: true, rating: 4.6, reviews: 14 },
  { id: 'wt-3', title: 'Essentials Sweatpants Women', price: 740.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Essentials Graphics Bedazzled Slouchy Pants Women', price: 1660.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-1', title: 'PUMA Class Sweatpants Women', price: 1150.00, description: 'Inwear Pink Side Trim Cropped Top—a stylish crop top in vibrant pink, crafted from 100% polyester with side trim detail, short sleeves, and a classic crew neck.', image: '/images/womens-crop-tee.jpg', category: 'womens-tshirts', stock: 22, trending: true, rating: 4.4, reviews: 27 },

  // Dresses & Skirts
  { id: 'wt-2', title: 'T7 Slim Love Of The Cat Full-Zip Dress Women', price: 1540.00, description: 'a retro-inspired piece with brown and pink stripes, a relaxed fit, and classic polo collar. Crafted from breathable cotton single jersey with a half-button placket and 3/4 sleeves.', image: '/images/womens-pink-tee.jpg', category: 'womens-tshirts', stock: 16, new: true, rating: 4.6, reviews: 14 },
  { id: 'wt-3', title: 'T7 Balloon Midi Skirt Women', price: 1899.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Wardrobe Essentials Cargo Skirt Women', price: 900.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'T7 Midi Pleated Skirt Women', price: 1739.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'T7 Balloon Skirt Women', price: 1200.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  
  // Women's Shorts
  { id: 'wt-3', title: 'PWRMODE Woven Shorts Women', price: 1620.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'FUTURE.PUMA.ARCHIVE Skort Women', price: 1040.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'VELOCITY 3" Running Shorts Women', price: 1739.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Train All Day Essentials 5" High-Waist Shorts Women', price: 850.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },

  // Womens Jackets
  { id: 'wt-3', title: 'T7 Cropped Track Jacket Women', price: 1520.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Essentials Slim Track Jacket Women', price: 1340.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'FUTURE.PUMA.ARCHIVE T7 Cropped Track Jacket Women', price: 1239.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Style Jacket Women', price: 2050.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },

   // Women's Crews & Hoodies
  { id: 'wt-3', title: 'PUMA x HYROX Heavyweight Crew Women', price: 1420.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'PUMA x HYROX Heavyweight Hoodie Women', price: 1540.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'Essentials Graphics Animal Hoodie Women', price: 1339.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'HER Oversized Hoodie Women', price: 1450.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'Essentials Elevated Logo Sweatshirt Women', price: 1339.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Street Glam Bedazzled Hoodie Women', price: 1750.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },

   //Women's Underwear & Bras
  { id: 'wt-4', title: 'MOVE PUMA STRONG Bra Women', price: 1450.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'Shapeluxe Mid Sports Bra Women', price: 1339.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Street Glam Bedazzled Hoodie Women', price: 1750.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  
  //Women's Women's Caps & Hats
{ id: 'wt-4', title: 'BMW M Motorsport Heritage Dad Cap', price: 550.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'Essentials No.1 Logo Bucket Hat', price: 409.00, description: 'This classic, nautical-inspired pullover features blue and white horizontal stripes, signature embroidery, a comfortable crew neck, and long sleeves.', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Prime Graphic Dad Cap', price: 509.00, description: 'a modern classic in a versatile beige polyblend suiting fabric, perfect for adding a casual edge to any look.', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-4', title: 'Amara Pink Winter Wrap', price: 400.00, description: 'Amara Pink Winter Wrap', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
  { id: 'wt-3', title: 'Sierra Straw hat With Bow - Black', price: 319.00, description: 'Sierra Straw hat With Bow - Black', image: '/images/womens-striped-tee.jpg', category: 'womens-tshirts', stock: 14, rating: 4.2, reviews: 9 },
  { id: 'wt-4', title: 'Lucia Wide Brim Hat', price: 319.00, description: 'Lucia Wide Brim Hat', image: '/images/womens-black-tee.jpg', category: 'womens-tshirts', stock: 19, rating: 4.3, reviews: 13 },
   //Women's Bags
